...
(6, 123, 'carwash', 123, 'pemilik', 'ppemilik', 'car', 0, 'car', '', 'Aktif', 0),
(7, 77777777, 'Bersih bersinar', 865432176, 'bojongsoang@gmail.com', 'bojongsoang', 'bojongsoang', 0, 'bersih bersinar sunlight', '', 'Aktif', 0);
...
--
ALTER TABLE `carwash`
  MODIFY `id_carwash` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
