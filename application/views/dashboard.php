...
<!-- Mirrored from mediacity.co.in/autoplus/car-wash/version1/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 May 2018 15:29:12 GMT -->
<head>
...
<!--  navigation -->
  <?php include 'layout/header_dashboard.php'; ?> 
<!--  end navigation -->
<!--  slider -->
  <div id="home-slider" class="home-slider">
    <div class="item home-slider-bg" style="background-image: url('http://localhost/carwash/assets/images/slider-1.jpg')"> 
      <div class="container">
    ...
    <div class="item home-slider-bg" style="background-image: url('http://localhost/carwash/assets/images/slider-2.jpg')">  
      <div class="container">
        <div class="slider-dtl">
          <h4 class="slider-sub-heading">We Care</h4>
          <h1 class="slider-heading">For Your Car</h1>
    ...
    <div class="item home-slider-bg" style="background-image: url('http://localhost/carwash/assets/images/slider-3.jpg')">  
      <div class="container">
        <div class="slider-dtl">
          <h4 class="slider-sub-heading">We Care</h4>
          <h1 class="slider-heading">For Your Car</h1>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-01.png" class="img-responsive" alt="service-01"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Vehicle Hand Wash</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-02.png" class="img-responsive" alt="service-02"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Headlight Lens Restoration</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-03.png" class="img-responsive" alt="service-03"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Scratch Removal</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-04.png" class="img-responsive" alt="service-04"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Tar Removal</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-05.png" class="img-responsive" alt="service-05"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Odor Elimination</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-06.png" class="img-responsive" alt="service-06"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Engine Cleaning</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-07.png" class="img-responsive" alt="service-07"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Hazardous Cleaning</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="service-block text-center">
            <div class="service-icon">
              <a href="services-details.html"><img src="<?php echo base_url('assets_dashboard/'); ?>images/icons/service-08.png" class="img-responsive" alt="service-08"></a>
            </div>
            <div class="service-dtl">
              <a href="services-details.html"><h5 class="service-heading">Valet Service</h5></a>
              <p>Lorem ipsum dolor sit amet cons elit aenean commodo ligula egetetsg cum sociis natoque enatib.</p>
            </div>
          </div>
        </div>
...
<!--  end map -->
<!--  footer -->
  <?php include 'layout/footer_dashboard.php'; ?>
<!--  end footer -->
<!-- jquery -->
...
<script>
  jQuery(function($) {
    ...
    script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCE0T8YQv3H3Q0ZJVvhyf8jO4YXfvUsnE4&amp;sensor=false&amp;callback=initialize";
...
<!-- Mirrored from mediacity.co.in/autoplus/car-wash/version1/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 May 2018 15:29:58 GMT -->
</html>