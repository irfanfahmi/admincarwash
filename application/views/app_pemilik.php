                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($value->status=='Aktif'){ ?>
                                                <a href="<?php echo site_url('akun/input_akun/').$value->id_carwash; ?>" class="btn btn-warning"><i class="fa fa-times"></i></a>
                                                <a href="" class="btn btn-success"><i class="icon-pencil"></i></a>
                                                <a href="" class="btn btn-danger"><i class="icon-trash"></i></a>
                                            <?php }else{ ?>
                                                <a href="<?php echo site_url('akun/input_akun/').$value->id_carwash; ?>" class="btn btn-warning"><i class="fa fa-check"></i></a>
                                                <a href="" class="btn btn-success"><i class="icon-pencil"></i></a>
                                                <a href="" class="btn btn-danger"><i class="icon-trash"></i></a>
                                            <?php } ?>
                                        </td>
