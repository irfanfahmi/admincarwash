        ...
        <ul class="navbar-nav left-side-nav" id="accordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My Carwash">
                <a class="nav-link" href="#">
                    <i class="ti-car"></i>
                    <span class="nav-link-text">My Carwash</span>
                </a>
                <!-- <a class="nav-link nav-link-collapse" data-toggle="collapse" data-target="#carwash">
                    <i class="ti-car"></i>
                    <span class="nav-link-text">My CarWash </span>
                </a> -->
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pesanan">
                <!-- <a class="nav-link" href="<?php echo base_url('kasir/data_carwash') ?>">
                    <i class="ti-receipt"></i>
                    <span class="nav-link-text">Pesanan <span class="badge badge-danger">5</span></span>
                </a> -->
                ...
                <ul class="sidenav-second-level collapse" id="antri" data-parent="#accordion">
                    ...
                    <li> <a href="<?php echo site_url('kasir/data_transaksi'); ?>">Kelola Pesanan <span class="badge badge-danger">5</span> </a> </li>
                </ul>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="<?php echo base_url('kasir/data_transaksi') ?>">
                    <i class="ti-money"></i>
