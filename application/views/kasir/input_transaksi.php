    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="page-title mb-4 d-flex align-items-center">
                <div class="mr-auto">
                    <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Input Transaksi</h4>
                    ...
                    <div class="card card-shadow mb-4">
                        <div class="card-header border-0">
                            <div class="custom-title-wrap bar-primary">
                                <div class="custom-title">Input Transaksi</div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="" id="default" method="post" action="<?php echo base_url('kasir/proses_transaksi'); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label col-form-label-sm">No. Polisi</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Merk Mobil" name="merk_mobil" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select class="form-control" id="jenis" name="jenis_cuci">
                                            <option></option>
